...
<p align="center">I'm graduating in Computer Science on URI - Santo Ângelo. Lately I've been following the Rocketseat way to study, wich proposes a Javascript stack: NodeJS + ReactNative e React. With this stack, it's possible to deliver a solution both for web and mobile environments, and my great goal is to reach a level wich I could create the entire application (or to have the knowledge to achieve this) in other words, becoming a fullstack developer.</p>
